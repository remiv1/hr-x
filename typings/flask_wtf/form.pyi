...
class FlaskForm(Form):
    ...
    class Meta(DefaultMeta):
        ...
        def wrap_formdata(self, form, formdata): # -> CombinedMultiDict[Any, Any] | ImmutableMultiDict[str, str] | ImmutableMultiDict[Any, Any] | None:
            ...
        
        def get_translations(self, form): # -> _SupportsGettextAndNgettext | Translations | None:
            ...
    ...
    def validate_on_submit(self, extra_validators=...): # -> bool:
